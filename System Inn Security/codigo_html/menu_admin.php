...
<body>
    ...
    <div class="wrapper">
        <div class="wrapper__menu">
            ...
            <div class="wapper__menu-submit">
                <a href="consultar_usuarios.php"><input class="submit" type="button" value="Verificar usuarios"></a>
            </div>
            <div class="wapper__menu-submit">
                <a href="Informes.php"><input class="submit" type="button" value="Informes"></a>
            </div>
            <div class="wapper__menu-submit">
                <a href="form_registro_visitante.php"> <input class="submit" type="button" value="Registro Visitante"> </a>
            </div>
            <div class="wapper__menu-submit">
                <a href="consultar_visitante.php"> <input class="submit" type="button" value="Consultar visitantes"> </a>
            </div>
            <div class="wapper__menu-submit">
